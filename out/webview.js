...
function handleProject() {
  ...
  if (projectAndClusterGroup != void 0) {
...
function handleRadio() {
  const radioButtonss = document.getElementsByName("cluster_radio");
...
function downloadKube() {
  let radioButtons = document.getElementsByName("cluster_radio");
  let flag = 0;
